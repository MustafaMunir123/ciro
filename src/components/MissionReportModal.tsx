                        ...
                        <div className="flex flex-col md:flex-row justify-between gap-6 items-start">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-zinc-500 uppercase">Emergency Response Management System // Project</p>
                    ...
                    <div className="report-footer bg-white border-t border-zinc-300 p-8 shrink-0">
                        <div className="flex flex-col md:flex-row justify-between items-end gap-6">
                            <div className="space-y-4">
                                ...
                                <div className="font-serif italic text-2xl text-zinc-300 select-none">Project Oversight</div>
                            </div>
